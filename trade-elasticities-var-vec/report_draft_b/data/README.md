...
The `processed/` folder separates the final panel from auxiliary processed
datasets.

- `final_data_panel/trade_elasticities_var_vec_panel_transformed_2004_2025.csv`
  and `final_data_panel/trade_elasticities_var_vec_panel_transformed_2004_2025.dta`

  Main final dataset for TP 3. It includes levels, natural logarithms, first
  ...
  and the data panel to share when requested. The CSV is the main script input;
  the DTA is the Stata-format equivalent.

- `auxiliary_data/trade_elasticities_var_vec_panel_base_2004_2025.csv`
...
- `auxiliary_data/trade_elasticities_var_vec_panel_complete_cases_2004_2025.csv`
...
- `auxiliary_data/trade_elasticities_var_vec_panel_modeling_2004_2025.dta`
...
1. Use `final_data_panel/trade_elasticities_var_vec_panel_transformed_2004_2025.csv`
   as the main input for the TP 3 script.
