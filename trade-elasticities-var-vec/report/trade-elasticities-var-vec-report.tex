...
\pendiente{Completar pruebas de normalidad y, si corresponde, una síntesis de
elasticidades de corto plazo del VECM. Exportaciones debe permanecer como
ejercicio indicativo si se fuerza un VECM, porque el rango Johansen es cero y la
variable dependiente fue clasificada como I(0).}
...
Tablas y figuras exportadas & Parcial \\
