...
\path{section_03_var_lag_diagnostic_decision.csv}.
...
Exportaciones & I(0) & No & Rango \(0\) con \texttt{const} y \texttt{none} &
...
script. Esta tabla proviene de \path{section_06_feedback_audit.csv}.
